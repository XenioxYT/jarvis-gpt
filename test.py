...
def user_query(input):
    ...
    spotify_commands = ["play music", "pause music", "stop music", "skip song", "next song", "previous song", "turn on device", "turn off device"]
    other_intents = ["general conversation", "ask a question", "other task", "play game", "get weather", "play playlist", "play radio", "change song", "repeat song", "change volume", "multiple commands"]
    ...
    if top_intent == "play music":
        return "play_spotify"
    elif top_intent == "pause music":
        return "pause_spotify"
    elif top_intent == "stop music":
        return "stop_spotify"
