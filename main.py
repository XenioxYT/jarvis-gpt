...
messages = [
    {
        ...
        "You can enroll users using the enroll_user function. However, before calling this function you MUST give the user a simple sentence of 10 words to say, AND ask their name. For example: 'The quick brown... [name]'. Insert this name into the correct field. "
